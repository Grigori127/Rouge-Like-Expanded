...
#Kitty Stats   
  ...
  # Sexual Encounters
    ...
    $ K_Tied = 0 if "K_Tied" not in globals().keys() else K_Tied
    $ K_TiedTimes = 0 if "K_TiedTimes" not in globals().keys() else K_TiedTimes
    $ K_TiedDuration = 0 if "K_TiedDuration" not in globals().keys() else K_TiedDuration
