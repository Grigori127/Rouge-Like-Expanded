    ...
    #End Handy dialog ////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if not Speed:
                        if K_Tit > 2:
                            ...
                            $ Line = "Kitty squeezes her breasts togather and slowly moves them along your shaft"
                        $ Speed = 1
...
label Kitty_Self_Set(Mode = "T3", Action = Trigger3, Length=0, Count2=0, Options = []): 
        ...
        if Action != Options[Count2]: #If the action remains the same as it was.
                ...
                if Action == "hand": 
                        ...
                        $ Line = "Kitty's hands slide up her body and begin to kneed her breasts. "
        elif Action == "hand": 
                $ Line = "Also, Kitty continues stroke your cock. "
        else:        
                $ Line = "Also, Kitty continues to masturbate. "
...
label Kitty_SexDialog_Threeway(Mode = 0, Action = 0, ActiveGirl = Primary, TempLine = 0, TempLust = 0, TempLust2 = 0, TempFocus = 0):
    ...
    call Kitty_Threeway_Set(Mode = Mode) from _call_Kitty_Threeway_Set   #Picks a new activty on a 7-9 roll or when not set, otherwise returns
